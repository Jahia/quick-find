/**
 * Sticky header for the QuickFind search panel.
 *
 * Layout:
 *   - Top row: "Welcome to QuickFind" title (left) + site/language info (right)
...
import s from "./QuickFindHeader.module.css";

type QuickFindHeaderProps = {
      ...
      <div className={s.header}>
          <div className={s.titleRow}>
              <Typography variant="title">
                  {t("search.modal.title", "Welcome to QuickFind")}
              </Typography>
          ...
          <div ref={inputWrapperRef} data-quick-find-search-input-wrapper="true">
              <form
          role="search"
          data-quick-find-search-form="true"
